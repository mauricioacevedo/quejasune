<?php 
	...
	if($operacion!=""){//hay una accion a realizar
		...
		if($operacion=="editar"){
			...
			$sql="select contratista,label, correos_para, correos_copia from envio_trabajo_contratistas where id=$id";
			$result = pg_query($sql);
			...
			$sql="insert into envio_trabajo_contratistas (contratista,correos_para,correos_copia,label) values ('$nombre','$correos','$conCopia','$label')";
			
			$result = pg_query($sql);

			$msg = "Operacion realizada con exito.";
                        header("Location: ./contratistas_envio_trabajo.php?msg=$msg");
			return;
			...
			$sql="update envio_trabajo_contratistas set contratista='$nombre',correos_para='$correos',correos_copia='$conCopia',label='$label' where id=$id";
			...
			$sql="delete from envio_trabajo_contratistas where id=$id";
			$result = pg_query($sql);
	...
	$rows=pg_numrows($result);
        ...
        $nombreForma="Agregar Contratista Envio Trabajo";
        $linkForma="./agregarContratistaEnvioTrabajo.php";
...
<script language="javascript">
	...
	function guardarInformacion(){
                ...
                var request="&contratista="+contratista+"&label="+label+"&correos="+correos+"&conCopia="+conCopia;
                location.href="./agregarContratistaEnvioTrabajo.php?operacion=insertarContratista"+request;
        }
        ...
        function editarInformacion(){
                ...
                var request="&contratista="+contratista+"&label="+label+"&correos="+correos+"&conCopia="+conCopia;
                location.href="./agregarContratistaEnvioTrabajo.php?operacion=editarContratista"+request+"&id=<? echo $id; ?>";
        }
...
<center><input value="Guardar" type="submit">&nbsp;<input value="Cancelar" type="button" onclick="javascript:location.href='./contratistas_envio_trabajo.php';"></center>
