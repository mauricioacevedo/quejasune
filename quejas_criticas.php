<?php 
	...
	//$rows=pg_numrows($result);
        ...
        $nombreForma="Quejas Criticas";
        $linkForma="./quejas_criticas.php";	
...
<body>
<? include 'header.php'; ?>
<center><h2>Correos de Quejas Criticas y Aceptables</h2></center>

<form enctype="multipart/form-data" action="quejas_criticas_2.php" method="post">
...
<br>
<center><a href="./modificar_contratistas.php">Modificar Contratistas</a></center>
